export const pages = [
  {
    ...
    image: '.\\src\\images\\map1.png', // Replace with the actual path to the cover image
  ...
  },
  {
    ...
    Saed, with a light step that barely disturbed the dew on the leaves, approached a moss-covered obelisk. The moment his fingers brushed against the ancient stone, a torrent of whispers flooded his senses, an echo of the outpost's guardians. Images flashed before his eyes—elves in radiant armor standing sentinel, their vows to protect Edoria's heart mingling with the magic imbued in the very stones of the outpost.
...
The Shattered Plains, with its surreal beauty and inherent danger, had been a crucible, tempering their resolve and deepening the bonds forged on their journey. As they stood at the threshold of the sanctuary, the adventurers were not merely a group of individuals brought together by fate; they were a united force, ready to face whatever lay beyond, their spirits woven together in the quest for harmony and the restoration of their world. `, 
  ...
  },
  {
    ...
    They turned to their companions, a band of heroes who had become family. In each other's eyes, they saw the reflection of their shared journey—the trials, the laughter, the moments of despair turned to triumph. There was a silent agreement that, though this chapter had closed, their story was far from over.
  ...
  },
  {
    ...
    In that ephemeral moment, they glimpsed themselves in other lives, other adventures—Juana, with her spells weaving through the fabric of unknown realms, and Saed, his bow guarding secrets in forests that stretched beyond imagination. Yet, amidst this kaleidoscope of existences, their eyes met, and an unspoken understanding passed between them. Their bond, forged through trials and triumphs, remained unaltered, a constant in the flux of infinite possibilities.
